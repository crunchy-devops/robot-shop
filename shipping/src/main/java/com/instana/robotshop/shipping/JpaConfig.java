...
public class JpaConfig {
    ...
    public DataSource getDataSource() {
        String JDBC_URL = String.format("jdbc:mysql://%s:%s/cities?allowPublicKeyRetrieval=true&useSSL=false&autoReconnect=true", System.getenv("DB_HOST") == null ? "mysql" : System.getenv("DB_HOST"),
